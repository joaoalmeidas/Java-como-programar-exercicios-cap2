package diametrocircuferenciacirculo;
...
public class Circulo {
	...
	public static void main(String[] args) {
		...
		System.out.println("Calcula o diâmetro, circunferência e área de um círculo.");
		
		System.out.print("Insira o raio da circinferência:");
		raio = input.nextInt();
		
		System.out.printf("Diâmetro: %d%nCircunferência: %f%nÁrea: %f", 2 * raio, 2 * Math.PI * raio, Math.PI * (raio * raio));
